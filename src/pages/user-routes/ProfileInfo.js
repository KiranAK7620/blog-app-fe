            ...
            <Table responsive striped hover bordered={true} className='text-center mt-5'>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <Input type='text' value={newUser.name} onChange={event=>handleChange(event,'name')}/>
                  </td>
                </tr>
                <tr>
                  <td >
                ...
                <tr>
                  ...
                  <td>
                    <Input type='textarea' value={newUser.about} onChange={event=>handleChange(event,'about')} />
                  </td>
